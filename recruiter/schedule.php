...
<body>
    ...
    <div class="container" style="min-height: 75vh; padding: 30px;">
        ...
        <div class="list" id="list" style="width: 100%;">
            ...
            <!-- Schedule Card  -->
            <div class="card" style="width: 30rem; min-height: 10rem; max-height: 22rem;">
                <div class="card-body">
            ...
            XRH.onload = function() {
                ...
                if (schedule != "") {
                    for (let i of schedule) {
                        tabledata += ' <div class="card" style="width: 30rem; height: 15rem; margin-bottom: 10px;"><div class="card-body"><h5 class="card-title">' + i.scheduleTitle + '</h5><h6 class="card-subtitle mb-2 text-muted">Placement Date : ' + i.schedulePlacementdate + '</h6><p class="card-text">' + i.scheduleDecription + '<br><a href="scheduleUpdate.php?scheduleId=' + i.scheduleId + '" class="card-link">Update schedule</a><a href="#" id="' + i.scheduleId + '"  data-bs-toggle="modal" data-bs-target="#deltetModal" onclick="getAllSheduleDetails(this.id)" class="card-link">Delete schedule</a></div></div>';
                    }
