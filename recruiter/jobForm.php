...
<head>
    <title>Add New Job for Recruiter</title>
            ...
            <form action="./php/addJob.php" method="post">
                <div class="row-1">
                    <div class="col-1">
                        <div class="input">
                            ...
                            <input type="text" name="title" placeholder="Title" onkeydown="return /[a-zA-Z \-]/i.test(event.key)"
                                required>
                            ...
                            <input type="number" name="stipend" list="stipendlist" placeholder="Stipend" id="stipend" required>
                            ...
                            <input type="text" name="workMode" placeholder="Job Mode" id="workMode" onkeydown="return /[a-zA-Z \-]/i.test(event.key)"  list="work" required>
                            <datalist id="work">
                    ...
                    <div class="col-1">
                        <div class="input">
                            ...
                            <input type="text" placeholder="Exprience" name="exprience" list="expriencelist" required>
                            ...
                            <input placeholder="Last date for Apply" type="text" name="lastdate" onfocus="(this.type = 'date')"
                                id="date" required>
                            ...
                            <input type="text" list="Location" placeholder="Location" name="location"  id="location" required />
                ...
                <select name="detail" id="detail">
                    ...
                    <optgroup label="Network and system administration job titles">
                        ...
                        <option>System administrator (also known as admin)</option>
                        <option>Wireless network engineer</option>
                    </optgroup>
                    ...
                    <optgroup label="Database administration job titles">
                        ...
                        <option>Database report writer</option>
                        <option>SQL datavase administrator</option>
                    </optgroup>

                    <optgroup label="Business analyst and business intellligence job titles">
                        <option>Big data engineer/architech</option>
                        <option>Business intelligence specialist/analyst</option>
                        <option>Business systems analyst</option>
                        <option>Data analyst</option>
                        <option>Data analytics developer</option>
                        <option>Data modelling analyst</option>
                        <option>Data scientist</option>
                        <option>Data warehouse manager</option>
                        <option>Data warehouse programing specialist</option>
                        <option>Intelligence specialist</option>
                    </optgroup>

                    <optgroup label="Software development, DevOps and cloud job titles">
                        <option>Back-end developer</option>
                        <option>Cloud/Software architech</option>
                        <option>Cloud/Software developer</option>
                        <option>Cloud/Software application engineer</option>
                        <option>Cloud sysstem administrator</option>
                        ...
                        <option>UI(User Interface) designer</option>
                        <option>UX(User Experience) designer</option>
                        <option>Web developer</option>
                    </optgroup>

                    <optgroup label="Security job titles">
                        <option>Application security administrator</option>
                        <option>Arificial intelligence security specialist</option>
                        <option>Cloud security specialist</option>
                        <option>Cyber security hardware engineer</option>
                        <option>Cyber intelligence specialist</option>
                        <option>Cryptographer</option>
                        <option>Data privacy officer</option>
                        <option>Digital forensics analyst</option>
                        <option>It security engineer</option>
                        <option>Information assurance analyst</option>
                        <option>Security systems administrator</option>
                    </optgroup>

                    <optgroup label="Help desk and  customer support job titles">
                        <option>Help desk support specialist</option>
                    ...
                    <optgroup label="Project and product management job titles">
                        ...
                        <option>Porfolio manager</option>
                    </optgroup>
                ...
                <div class="row-2">
                    <div class="input2">
                        <div class="sect-3">
                            <a href="#"><i class="fa-solid fa-arrow-left"></i>Back to Job Page</a>
                        </div>
                        <div class="sect-4">
