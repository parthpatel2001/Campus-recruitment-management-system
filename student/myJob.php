...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="myJob.php">Jobs</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <div class="profile_pic" style="width: 60px; height: auto;">
                            <a class="nav-link" href="#" id="image-link">
                                <img src="ProfilePicture/<?php echo $_SESSION["studentProfilepicture"]; ?>" id="image-1" width="100%" height="auto"></a>
    ...
    <script>
        ...
        function fetchAlldata() {
            ...
            XRH.onload = function() {
                ...
                for (let job of recruiter) {
                    ...
                    var lastDate =new Date(job.lastdate); //fetch last date of job
                    ...
                    tabledata +=
                        ...
                        job.jobId +
                        '" onclick="getJobDetails(this.id)">Apply</button></div></div></div></div></div></div></div>';
                }
        ...
        function getJobDetails(val) {
            ...
            console.log(job);
            document.getElementById('jobTitle').innerHTML = job.jobTitle;
            document.getElementById('company_Name').innerHTML = "Company Name : " + job.companyName;
            document.getElementById('experience1').innerHTML = "Experience: " + job.jobExperience;
            document.getElementById('stipend1').innerHTML = "Stipend: " + job.jobStipend;
            document.getElementById('package1').innerHTML = "Salary : " + job.jobSalary + " LPA";
            document.getElementById('bond1').innerHTML = "Bond: " + job.jobType;
            document.getElementById('work_Mode').innerHTML = "Work Mode : " + job.jobMode;
            document.getElementById('Location1').innerHTML = "Location : " + job.jobLocation;
            document.getElementById('lastdate1').innerHTML = "Last date : " + job.lastdate;
        ...
        // Insert Application on Database
        function addApplication() {
            ...
            XRH.open('POST', './php/addApplication.php');
            XRH.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            XRH.send(data);
        }
